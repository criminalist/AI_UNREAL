...
class AGENTINTEGRATIONKIT_API FAgentService
{
public:
	...
	void RespondToPermission(const FString& AgentName, int32 RequestId, const FString& OptionId, TSharedPtr<FJsonObject> OutcomeMeta = nullptr);
