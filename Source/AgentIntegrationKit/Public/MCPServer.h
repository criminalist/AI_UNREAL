...
private:
	...
	TSharedPtr<FJsonObject> HandleToolsCall(TSharedPtr<FJsonValue> Id, TSharedPtr<FJsonObject> Params);
	TSharedPtr<FJsonObject> HandleResourcesList(TSharedPtr<FJsonValue> Id, TSharedPtr<FJsonObject> Params);
	TSharedPtr<FJsonObject> HandleResourceTemplatesList(TSharedPtr<FJsonValue> Id, TSharedPtr<FJsonObject> Params);

	/** Async tool execution with timeout - sends response via callback */
	bool HandleToolsCallAsync(TSharedPtr<FJsonValue> Id, TSharedPtr<FJsonObject> Params, const FHttpResultCallback& OnComplete);
...
private:
	...
	FHttpRouteHandle LegacyRouteHandleSlash;
	FHttpRouteHandle StreamableHTTPGetHandleSlash;
	FHttpRouteHandle OptionsRouteHandleSlash;
	FHttpRouteHandle DeleteRouteHandleSlash;
