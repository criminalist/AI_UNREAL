 ...
 */
class AGENTINTEGRATIONKIT_API FOmniRouteProvider : public IChatGatewayProvider
{
public:
	virtual EChatGatewayProviderId GetProviderId() const override { return EChatGatewayProviderId::OmniRoute; }
	virtual FString GetProviderIdString() const override { return TEXT("omniroute"); }
	virtual FString GetDisplayName() const override { return TEXT("OmniRoute"); }
	virtual FString GetDescription() const override { return TEXT("Local AI gateway via OmniRoute (OpenAI-compatible)"); }

	virtual FString GetDefaultBaseUrl() const override { return TEXT("http://localhost:20128/v1"); }
	virtual FString GetDefaultModel() const override { return TEXT("if/kimi-k2-thinking"); }
	virtual TArray<FACPModelInfo> GetHardcodedModels() const override;
	virtual bool SupportsModelDiscovery() const override { return true; }
	virtual TArray<FACPModelInfo> ParseModelsResponse(const FString& ResponseBody) const override;
