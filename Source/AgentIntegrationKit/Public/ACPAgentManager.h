...
public:
	...
	bool CanLogoutAgent(const FString& AgentName, FString& OutCommandPreview, FString& OutReason);
	void LogoutAgent(const FString& AgentName);
...
private:
	...
	bool BuildAgentLogoutCommand(const FString& AgentName, FString& OutCommandLine, FString& OutReason);
