...
private:
	...
	TSharedPtr<FJsonValue> ResolveInboundRequestIdValue(int32 RequestId);
...
private:
	...
	int32 NextInboundRequestId = -1;
	TMap<int32, TSharedPtr<FJsonValue>> PendingInboundRequestIds; // Surrogate Id -> Original JSON-RPC id value
